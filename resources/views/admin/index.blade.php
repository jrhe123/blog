	...
	<ul>
		...
		<li>
			...
			<ul class="sub_menu" style="display: block">
				<li><a href="{{url('admin/links/create')}}" target="main"><i class="fa fa-fw fa-cubes"></i>友情链接</a></li>
				<li><a href="{{url('admin/navs/create')}}" target="main"><i class="fa fa-fw fa-navicon"></i>自定义导航</a></li>
		...
		<li>
			...
			<ul class="sub_menu">
				...
				<li><a href="\resources\views\admin\element.html" target="main"><i class="fa fa-fw fa-tags"></i>其他组件</a></li>
			</ul>
		</li>
	</ul>
</div>
